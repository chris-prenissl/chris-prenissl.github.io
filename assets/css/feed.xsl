...
>
  ...
  <xsl:template match="atom:feed">
    ...
    <p>Thanks to Android Stiefel that provided the basis for styling this feed. Visit <a href="https://andrewstiefel.com/style-atom-xsl">How to Style An Atom Feed With XSLT</a></p>
  </xsl:template>
